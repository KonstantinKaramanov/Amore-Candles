...
export default function CheckoutModal({ cart, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md max-h-[95vh] overflow-y-auto">
        <form onSubmit={handleSubmit}>
          ...
          <label className="block text-sm font-medium">Офис за доставка</label>
          <input
            className="w-full border rounded p-2 mb-4"
            placeholder="Въведете адрес или име на офис"
            value={office}
